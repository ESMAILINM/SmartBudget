...
import edu.ucne.smartbudget.presentation.gasto.GastoUiState
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        if (isEditing) "Editar Gasto" else "Nuevo Gasto",
        ...
        Column(
            ...
            OutlinedTextField(
                value = state.monto,
                onValueChange = { onEvent(GastoUiEvent.MontoChanged(it)) },
                label = { Text("Monto") },
            ...
            OutlinedTextField(
                ...
                onValueChange = { onEvent(GastoUiEvent.DescripcionChanged(it)) },
            ...
            val nombreCategoriaSeleccionada = state.categorias
                .find { it.categoriaId == state.categoriaSeleccionadaId }?.nombre
                    ...
                    state.categorias
                        ...
                        .forEach { categoria ->
                            DropdownMenuItem(
                                ...
                                onClick = {
                                    onEvent(GastoUiEvent.CategoriaSelected(categoria.nombre))
                                    expanded = false
                                }
                            )
                        }
            ...
            Button(
                onClick = { onEvent(GastoUiEvent.Save) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(56.dp),
                colors = ButtonDefaults.buttonColors(
            ...
            confirmButton = {
                TextButton(onClick = {
                    datePickerState.selectedDateMillis?.let { millis ->
                        ...
                        onEvent(GastoUiEvent.FechaChanged(date))
                    }
                    onDismissDatePicker()
                }) { Text("Aceptar") }
            },
